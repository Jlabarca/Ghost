...
public interface ICache : IAsyncDisposable
{
    ...
    Task<bool> SetAsync<T>(string key, T value, TimeSpan? expiry = null, CancellationToken ct = default(CancellationToken));
    ...
    Task<IDictionary<string, T?>> GetManyAsync<T>(IEnumerable<string> keys, CancellationToken ct = default(CancellationToken));
    ...
    Task<bool> SetManyAsync<T>(IDictionary<string, T> items, TimeSpan? expiry = null, CancellationToken ct = default(CancellationToken));
    ...
    Task<int> DeleteManyAsync(IEnumerable<string> keys, CancellationToken ct = default(CancellationToken));
    ...
    Task<bool> UpdateExpiryAsync(string key, TimeSpan expiry, CancellationToken ct = default(CancellationToken));
    ...
    Task<bool> ClearAsync(CancellationToken ct = default(CancellationToken));
}
