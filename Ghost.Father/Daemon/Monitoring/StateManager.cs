...
public class StateManager
{
    ...
    public async Task PersistStateAsync()
    {
        ...
        try
        {
            ...
            try
            {
                var processes = await GetActiveProcessesAsync();
                ...
                //batch insert processInfo into db
                //TODO: where is our batch insert method?
                await _data.BulkInsertAsync(processes);
        ...
        {
            G.LogError(ex, "Failed to save process state");
            throw;
        }
    }
}