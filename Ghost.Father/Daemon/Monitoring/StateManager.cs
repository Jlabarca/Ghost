...
public class StateManager
{
    ...
    public async Task SaveProcessAsync(ProcessInfo process)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                string? appType = (process.Metadata.Configuration.TryGetValue("AppType", out string? type)
                        ? type
    ...
    public async Task SaveProcessMetricsAsync(string processId, ProcessMetrics metrics, string appType)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                byte[] serializedMetrics = Encoding.UTF8.GetBytes(
    ...
    public async Task<dynamic> GetProcessStatusAsync(string? processId)
    {
        ...
        try
        {
            ...
            dynamic? process = await _data.QuerySingleAsync<dynamic>(@"
                SELECT
                    p.id,
                    p.name,
                    p.type,
