...
{
    private readonly ConcurrentDictionary<string, ChannelMetrics> _channelMetrics = new ConcurrentDictionary<string, ChannelMetrics>();
    ...
    private class ChannelMetrics
    {
        ...
        private readonly List<double> _publishLatencies = new List<double>();
        private readonly List<double> _subscriptionLatencies = new List<double>();
        ...
        public void IncrementErrors(string operation)
        {
