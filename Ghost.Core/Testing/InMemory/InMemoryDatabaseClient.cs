...
public class InMemoryDatabaseClient : IDatabaseClient
{
    ...
    /// <inheritdoc />
    public Task<bool> IsAvailableAsync(CancellationToken ct = default(CancellationToken))
    {
        ThrowIfDisposed();
    ...
    /// <inheritdoc />
    public Task<long> GetStorageSizeAsync(CancellationToken ct = default(CancellationToken))
    {
        ThrowIfDisposed();
